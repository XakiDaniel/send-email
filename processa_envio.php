<?php
    ...
    if(!$mensagem->mensagemValida()){
        ...
        header('Location: index.php?erro=preencha os campos para enviar o email');
    } 
    ...
    try {
        ...
        //Recipients
        $mail->setFrom('desenvolvimentophpteste@gmail.com', 'Desenv Remetente');
        ...
        $mensagem->status['descricao_status'] = 'Não foi possível enviar esse e-mail, tente novamente mais tarde' . $mail->ErrorInfo;
    }
?>
            ...
            <div class="col-md-12">
                ...
                <?php
                    if($mensagem->status['codigo_status'] == 2) { ?>
                        <div class="container">
                            <h1 class="displa-4 text-danger">Ops!! erro ao enviar email</h1>
                            <p><?= $mensagem->status['descricao_status']; ?></p>
